            ...
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    ...
                    <li className="">
                        ...
                        <Image className="mt-3" src="/public/images/background.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li className="">
                    ...
                    <li className="mb-20">
                        ...
                        <Image className="my-4" src="/public/images/a1.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
