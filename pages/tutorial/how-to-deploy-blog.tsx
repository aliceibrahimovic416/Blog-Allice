...
import { PageLayout, Text, List, LinkTo, Seperator, Slider } from "../../src/components";
            ...
            <div className='container px-3 pb-5 md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    <li>
                        ...
                        <Image className="mt-5"src="/public/images/a1.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        Run <b>npm run out</b><br />
                        In the terminal run <b>npm run out</b>.
                        <Image className="mt-5" src="/public/images/a2.jpg" alt="nextjs-simple-blog-template" size={ImageSize.MEDIUM} />
                        <Image className="mt-5" src="/public/images/m1.jpg" alt="nextjs-simple-blog-template" size={ImageSize.MEDIUM} />
                    </li>
                    <li>
                        After the export is successful. You will see a new folder created named <b>out</b> in you project directory .
                        <Image className="my-5" src="/public/images/m2.jpg" alt="nextjs-simple-blog-template" size={ImageSize.XS} />
                ...
                <List type={ListType.disc} className="mt-5">
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/images/m3.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/images/m4.jpg" alt="nextjs-simple-blog-template" size={ImageSize.SMALL} />
                        <Image className="my-5" src="/public/images/m5.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <Image className="my-5"src="/public/images/m6.jpg" alt="nextjs-simple-blog-template" caption="Select Use an Existing Project" size={ImageSize.DEFAULT} />
                        ...
                        <Image className="my-5" src="/public/images/Mobile.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                        ...
                        <List type={ListType.number} className="mt-5">
                            <li>
                                ...
                                <Image className="my-5" src="/public/images/AppleBrand.jpg" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                            </li>
                            <li>
                        ...
                        <Image className="my-5" src="/public/images/FamousBrand.jpg" alt="nextjs-simple-blog-template" caption="Firebase Setup Complete" size={ImageSize.DEFAULT} />

                        Finally run <b>firebase deploy</b> and your peoject will be deployed on your firebase hosting.
                        <Image className="my-5" src="/public/images/touchcom.jpg" alt="nextjs-simple-blog-template" caption="Firebase Deploy" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        <b>* note</b><br />
